...
export CERTS_PATH="`pwd`/certs/$TENANT_NAME"
export SERVER_CERT="$CERTS_PATH/server-tf.crt"
export CLIENT_CERT="$CERTS_PATH/client-tf.crt"
export CLIENT_KEY="$CERTS_PATH/client-tf.key"
